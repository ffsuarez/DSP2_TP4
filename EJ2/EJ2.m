...
figure,
subplot(3,2,1),imshow(i1,[]),title('Filt F1'),
subplot(3,2,2),imshow(ig1,[]),title('Filt H1'),
subplot(3,2,3),imshow(i2,[]),title('Filt F2'),
subplot(3,2,4),imshow(ig2,[]),title('Filt H2'),
subplot(3,2,5),imshow(i3,[]),title('Filt F3'),
subplot(3,2,6),imshow(ig3,[]),title('Filt H3'),
