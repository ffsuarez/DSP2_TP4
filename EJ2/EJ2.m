...
%%
figure,
subplot(3,2,1),mesh(log(1+abs(fftshift(F1)))),title('Filtro Gaussian freq1'),
subplot(3,2,2),mesh(log(1+abs(fftshift(H1)))),title('Filtro Gaussian G=2 freq1'),
subplot(3,2,3),mesh(log(1+abs(fftshift(F2)))),title('Filtro Gaussian freq2'),
subplot(3,2,4),mesh(log(1+abs(fftshift(H2)))),title('Filt Gaussian G=2 freq2'),
subplot(3,2,5),mesh(log(1+abs(fftshift(F3)))),title('Filt BTW freq1'),
subplot(3,2,6),mesh(log(1+abs(fftshift(H3)))),title('Filt BTW G=2 freq1'),

figure,
subplot(3,2,1),mesh(log(1+abs(fftshift(F4)))),title('Filtro BTW freq2'),
subplot(3,2,2),mesh(log(1+abs(fftshift(H4)))),title('Filtro BTW G=2 freq2'),
subplot(3,2,3),mesh(log(1+abs(fftshift(F5)))),title('Filtro Ideal freq1'),
subplot(3,2,4),mesh(log(1+abs(fftshift(H5)))),title('Filt Ideal G=2 freq1'),
subplot(3,2,5),mesh(log(1+abs(fftshift(F6)))),title('Filt Ideal freq2'),
subplot(3,2,6),mesh(H6),title('Filt Ideal G=2 freq2'),